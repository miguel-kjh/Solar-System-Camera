public class Ship{
  ...
  public Ship(float x1,float x2, float y1, float y2, String pathImage){
   ...
   public void createShip(){
     textSize(wordSize/2);
     fill(255,255,255);
     text("W,S,A,D move the ship in X,Y",x*0.24,y*0.05);
     text("R,F move the ship in Z",x*0.185,y*0.15);
     text("Q,E rotate the camera",x*0.18,y*0.25);
